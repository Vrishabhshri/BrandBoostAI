...
const posts: Post[] = [
  { title: "Summer collection launch", details: "2.3K engagements • 15K reach", sentiment: "positive", sentimentValue: "48% Positive"},
  { title: "Product Update", details: "230 comments • 30,563 views", sentiment: "negative", sentimentValue: "55% Negative" },
  { title: "Customer Story", details: "230 comments • 30,563 views", sentiment: "neutral", sentimentValue: "48% Neutral" },
];
...
{/* Post Title & Details */}
            ...
            <span
              className={`text-[0.6rem] font-semibold text-black rounded-[1.5rem] px-2 w-[85px] h-[15px] flex flex-row items-center justify-center ${
