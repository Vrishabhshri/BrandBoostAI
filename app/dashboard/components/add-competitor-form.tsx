        ...
        {companyInfo && (
          <div className="mt-4">
            ...
            <ul className="list-disc list-inside">
              {companyInfo.hashtags.length > 0 ? (
                companyInfo.hashtags.map((tag) => <li key={tag}>{tag}</li>)
              ) : (
            ...
            <ul className="list-disc list-inside">
              {companyInfo.topCompetitors.length > 0 ? (
                companyInfo.topCompetitors.map((competitor) => <li key={competitor}>{competitor}</li>)
              ) : (
